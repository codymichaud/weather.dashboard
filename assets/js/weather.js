            ...
            if (forecastTimes[i].dt_txt[12] === "2") {
                ...
                if (displayForecast === false || displayForecast === undefined) {
                    $(".forecastList").append("<div class='my-3 pb-3 col-md-2 col-lg-2 forecast-day'>" +
                        ...
                        "<img class='ficon' src=" + forecastIconURL + " alt='Weather icon'>" + "<div>Temp: " + forecastTemp.toFixed(1) + " °F" +
...
//This will allow the user to search the weather data for previously searched cities when that city is clicked on
